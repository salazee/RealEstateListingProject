...
//       try {
//         const res = await getHouses(); // ✅ Use helper
...
//       <img src="https://images.unsplash.com/photo-1605146769289-440113cc3d00?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="House Image" className="w-full h-[60vh] object-cover rounded-lg mb-6"  />
//       <div className="absolute z-[1]">
//       <h1 className="text-3xl font-bold mb-6 text-center">Find Your Next Home</h1>
//       <p className="text-gray-600 max-w-xl mx-auto mb-8">
//         Browse verified properties, compare prices, and contact sellers directly.
//       </p>
//       </div>
//       </div>
